    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          <a href="https://drive.google.com/file/d/1BsW2qI5wgYKponxNPXMV8dYNMNQ9UToV/view?usp=drivesdk" target="_blank" rel="noopener noreferrer">
            <button
            ...
            >
              <div className="container mx-auto px-6 py-8">
                <div className="flex flex-col space-y-6">
                  ...
                  <motion.a
                    href="/https://drive.google.com/file/d/1BsW2qI5wgYKponxNPXMV8dYNMNQ9UToV/view?usp=drivesdk"
                    target="_blank"
