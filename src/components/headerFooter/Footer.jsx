        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            >
              ...
              <motion.a
                href="https://www.linkedin.com/in/akash-chandra-poddar-full-stack-developer-73aa7a195"
                target="_blank"
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <motion.p
              ...
              style={{ color: themeColors.summeryText }}
            >
              © {new Date().getFullYear()} <a href="https://www.linkedin.com/in/akash-chandra-poddar-full-stack-developer-73aa7a195"><span style={{ color: themeColors.primaryColor }}>Akash</span></a> · Coded with intent,
              designed with care.
            </motion.p>
