            ...
            <motion.div className="space-y-10" variants={containerVariants}>
              {[
                {
                  icon: "Mail",
                  title: "Email",
                  value: "akashpoddar492@gmail.com",
                  href: "mailto:akashpoddar492@gmail.com",
                },
                {
                  icon: "Phone",
                  title: "Phone",
                  value: "+91-6204899360",
                  href: "tel:+916204899360",
                },
                {
                  icon: "MapPin",
                  title: "Location",
                  value: "Gola, Ramgarh, Jharkhand",
                },
              ].map((item, i) => (
                <motion.div
              ...
              >
                <div className="absolute inset-0 flex items-center justify-center">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3658.0061871096264!2d85.71554447562558!3d23.53227987881979!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f45ba00df39a47%3A0x9eb8a9fae1884728!2sSundi%20tola%20gola!5e0!3m2!1sen!2sin!4v1766032972605!5m2!1sen!2sin"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
